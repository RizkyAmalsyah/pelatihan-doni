...
<div class="container-xxl" id="kt_content_container">
    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                <div class="w-100 mw-150px">
                    <!--begin::Select2-->
                    <select onchange="filter_category(this)" class="form-select form-select-solid table-filter me-2" data-control="select2">
                ...
                <!--begin::Add training-->
                <a role="button"  onclick="tambah_data()" data-bs-toggle="modal" data-bs-target="#kt_modal_training"  class="btn btn-primary">Add Data Training</a>
                <!--end::Add training-->
            </div>
            <!--end::Card toolbar-->
        </div>
        ...
        <div class="card-body pt-0">
            <!--begin::Table-->
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="table_training" data-url="{{ route('table.training') }}">
                <thead>
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            ...
            <div class="modal-body mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="form_training" class="form" action="{{ route('insert.training') }}"  method="POST" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column me-n7 pe-7" id="#">
                        ...
                        <div class="fv-row mb-7" id="req_sort_description">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea name="sort_description" id="sort_description" cols="30" rows="5"  class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter Sort Description"></textarea>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    ...
                    <div class="text-center pt-15">
                        <button type="button" id="submit_training" data-editor="description" onclick="submit_form(this,'#form_training')" class="btn btn-primary">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="text-center mb-13">
                    <!--begin::Title-->
                    <h1 class="mb-3">Peserta Terdaftar</h1>
                    <!--end::Title-->
                    <!--begin::Description-->
                    <div class="text-muted fw-semibold fs-5">Berikut adalah daftar user yang terdaftar dalam pelatihan <b class="text-primary" id="title_modal_register"></b></div>
                    <!--end::Description-->
                </div>
                <!--end::Heading-->
                <!--begin::Users-->
