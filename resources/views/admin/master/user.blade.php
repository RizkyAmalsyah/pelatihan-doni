    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <!--begin::Add user-->
                <a role="button"  onclick="tambah_data()" data-bs-toggle="modal" data-bs-target="#kt_modal_user"  class="btn btn-primary">Add User</a>
                <!--end::Add user-->
            </div>
            <!--end::Card toolbar-->
        </div>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="table_user" data-url="{{ route('table.user'); }}">
                <thead>
                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="text-center min-w-100px" data-searchable="false">Account Status</th>
